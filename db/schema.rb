...
# of editing this file, please use the migrations describe of Active Record to
...
ActiveRecord::Schema[7.1].define(version: 2026_01_04_102746) do
  ...
  create_table "sellers", force: :cascade do |t|
    t.bigint "trade_party_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["trade_party_id"], name: "index_sellers_on_trade_party_id"
  end
  ...
  create_table "trade_parties", force: :cascade do |t|
    t.string "name"
    t.string "legal_name"
    t.string "street"
