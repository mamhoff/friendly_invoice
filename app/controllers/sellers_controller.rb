class SellersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @seller.save
        format.html { redirect_to edit_seller_url(@seller), notice: "Seller was successfully created." }
        format.json { render :show, status: :created, location: @seller }
      else
        format.html { render :new, status: :unprocessable_content }
        format.json { render json: @seller.errors, status: :unprocessable_content }
      end
    end
  end
  ...
  def update
    respond_to do |format|
      if @seller.update(seller_params)
        format.html { redirect_to edit_seller_url(@seller), notice: "Seller was successfully updated." }
  ...
  def seller_params
    params.require(:seller).permit(:trade_partner_id)
  end
end
