...
feature "Invoices:" do
  ...
  describe "with b series" do
    ...
    scenario "User can update an invoice", :js do
  ...
  scenario "User can't update an invoice with invalid data", :js do
    visit edit_invoice_path(invoice)
  ...
  scenario "User can add a payment to an invoice", :js do
    visit edit_invoice_path(invoice)
  ...
  describe "with items and payments" do
    ...
    scenario "User can remove payments and items from an invoice", :js do
      visit edit_invoice_path(invoice)
