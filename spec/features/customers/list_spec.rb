...
feature "Customers:" do
  scenario "User can see a list of customers", :js do
  ...
  scenario "User can click on a customer to edit it", :js do
  ...
  scenario "User can access to the list of invoices for a certain customer", :js do
    customer = FactoryBot.create(:customer)
