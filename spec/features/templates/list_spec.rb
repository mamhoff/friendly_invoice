...
feature "Templates:" do
  ...
  scenario "User can see a couple of default templates if no change was made", :js do
    click_on "Account"
    click_on "Templates"
  ...
  scenario "User can change the default template from the list of templates", :js do
