...
feature "Settings:" do
  ...
  scenario "User can update data without changing password", :js do
    click_on "Account"
    click_on "Profile"
  ...
  scenario "User can update password", :js do
  ...
  scenario "User can't update password without old password", :js do
    visit settings_profile_path
  ...
  scenario "User can't update password if confirmation doesn't match", :js do
    visit settings_profile_path
