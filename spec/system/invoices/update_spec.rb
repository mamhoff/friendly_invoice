...
describe "Invoices:" do
  ...
  describe "with b series" do
    before do
      FactoryBot.create(:b_series)
    end

    specify "User can update an invoice", :js, :logged_in do
  ...
  specify "User can't update an invoice with invalid data", :js, :logged_in do
    visit edit_invoice_path(invoice)
  ...
  skip "User can add a new item to an existing invoice", :js, :logged_in do
    visit edit_invoice_path(invoice)
  ...
  specify "User can add a payment to an invoice", :js, :logged_in do
    visit edit_invoice_path(invoice)
  ...
  describe "with items and payments" do
    let(:items) do
      [
    ...
    specify "User can remove payments and items from an invoice", :js, :logged_in do
      visit edit_invoice_path(invoice)
