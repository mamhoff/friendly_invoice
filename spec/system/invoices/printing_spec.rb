...
describe "Invoices:" do
  ...
  specify "User will see a preview of a paid invoice inside an iframe an can download a PDF", :js, :logged_in do
    visit invoices_path
  ...
  specify "User can access the edit page from the print preview page", :js, :logged_in do
  ...
  specify "User can download selected invoices as PDF from the invoices list", :js, :logged_in do
    visit invoices_path
