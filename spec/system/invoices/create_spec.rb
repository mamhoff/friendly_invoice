...
describe "Invoices:" do
  ...
  specify "User can create an invoice. A customer is created.", :js, :logged_in do
  ...
  specify "User can choose an existing customer via autocomplete", :js, skip: true do
  ...
  specify "User can't create an invoice with no customer data or series", :js, :logged_in do
    visit new_invoice_path
    click_on "Save"
  ...
  specify "Saving a draft", :js, :logged_in do
