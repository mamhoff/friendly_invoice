...
describe "Recurring Invoices:" do
  specify "User can update a recurring invoice", :js, :logged_in do
  ...
  specify "User can't update a recurring invoice with invalid data", :js, :logged_in do
    recurring_invoice = FactoryBot.create(:recurring_invoice)
  ...
  specify "User can add a new item to an existing recurring invoice", :js, :logged_in do
    recurring_invoice = FactoryBot.create(:recurring_invoice)
    visit edit_recurring_invoice_path(recurring_invoice)
    click_on "Add Line"
