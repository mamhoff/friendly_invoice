...
describe "Recurring Invoices:" do
  ...
  specify "User can create a recurring invoice. A Customer is created.", :js, :logged_in do
    ...
    expect(Customer.find_by(email: "test@customer.com", identification: "12345")).not_to be_nil
  end

  specify "User can't create a recurring invoice with invalid data", :js, :logged_in do
    visit new_recurring_invoice_path
    click_on "Save"
